...
const ListInfoContainer = ({bg_color, title, info, img, title_color,lists_color, info_color, button, lists, btn_text, btn_bg, url}) => {
  return (
    <div>
                ...
                <section className='w-[40vw]'>
                  ...
                  <section className='w-[40vw]'>
                    ...
                    {lists && lists.map((item, index) => (
                        <li className={` ${lists_color ? lists_color : 'text-white'} mt-vw  text-vw `} key={index}>{item}</li>
                    ))}
