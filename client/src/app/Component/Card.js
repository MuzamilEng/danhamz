...
const Card = ({title, info, para, question, desc, number, img}) => {
  return (
    <>
                <section className={`bg-[#fff] m-vw border-t-[3px] border-blue-900 p-vw w-full max-w-[19vw] ${img ? 'h-[45vw]': 'h-[28vw]'}`}>
                ...
                {img && <img src={img} alt="rememter" className="w-full max-w-[15vw] h-[10vw] m-vw" />}
