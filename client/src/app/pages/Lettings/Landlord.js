  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 w-full flex justify-between items-start p-3vw">
        <h1 className='text-purple-950 text-[1.7vw] w-full max-w-[35vw] font-medium'>If you own high quality Student or Professional property across Leeds, we’d love to talk to you!</h1>
      ...
      {/* Why let your property with us? */}
        ...
        <article className="col-center bg-gray-200 w-full p-3vw">
            <h1 className='text-purple-950 text-[2.1vw] font-medium'>Why let your property with us?</h1>
             {/* doings */}
...
{/* reviews */}
 ...
 <div className="p-3vw bg-gray-200">
            <h1 className="text-purple-950 font-medium text-3vw text-center">Landlord Knowledge Bank</h1>
