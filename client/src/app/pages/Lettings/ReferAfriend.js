  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-gray-200'>
        <p className='text-[2vw] text-purple-950 font-semibold w-full max-w-[35vw]'>Share the love with our Refer a Friend Scheme</p>
      ...
      <article className="w-full bg-white">
       ...
       {/* banner */}
       <div className="w-full col-center bg-purple-950 p-5vw">
       ...
       <article className="w-full p-3vw bg-white flex flex-col justify-center items-center ">
        <div className="">
        <h1 className="text-purple-950 font-medium text-[1.9vw]">Terms</h1>
