  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 w-full flex justify-between items-start p-3vw">
        <h1 className='text-purple-950 text-[1.7vw] w-full max-w-[35vw] font-medium'>  There are a number of good reasons to consider letting your property instead of selling it.</h1>
       ...
       <div className="flex justify-center p-vw w-full items-center flex-col">
            <div className="w-full max-w-[55vw] p-2vw">
              <h1 className='text-blue-950 text-[2vw] ml-3vw w-full max-w-[40vw] text-center'>Things To Consider</h1>
