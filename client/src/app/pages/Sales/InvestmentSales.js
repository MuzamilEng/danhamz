  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-gray-200'>
        <p className='text-[1.7vw] text-purple-950 font-semibold w-full max-w-[38vw]'>Thinking of selling your investment property? <br />
          <span className='text-[1.3vw] text-purple-950 font-light w-full max-w-[37vw]'>Try our latest dedicated sales service for Landlords & Investors</span></p>
      ...
      <article className="col-center bg-gray-200 w-full p-3vw">
            <h1 className='text-purple-950 text-[2.1vw] font-medium'>Why sell your investment property with us?</h1>
             {/* doings */}
      ...
      <article className="col-center p-3vw bg-white">
        <h1 className='text-purple-950 text-[2.1vw] font-medium'>Recently Sold Properties</h1>
      ...
      <article className="w-full bg-white">
        ...
        {/* valuation */}
        <article className="col-center p-3vw bg-purple-950">
