  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-white'>
          <span className='text-[1.3vw] text-purple-950 font-semibold w-full max-w-[37vw]'>
      ...
      {/* banner */}
      <div className="col-center p-5vw bg-purple-950">
        <h1 className="text-[1.8vw] text-white font-bold text-center w-full max-w-[40vw]"> Now is a great time to sell.</h1>
      ...
      {/* sold properties */}
       <div className="w-full flex-col bg-white p-2vw flex justify-center items-center">
            <h1 className='text-blue-950 text-[1.9vw] text-center font-medium capitalize text-medium'>Recently sold properties</h1>
            ...
            <Link to="/" className="bg-purple-950 mt-2vw block p-vw m-vw text-white font-medium text-[0.8vw] text-center">Instant Sales Valuation</Link>
        </div>
        {/* reviews */}
        <section className="w-full">
          <RatingsContainer />
         ...
         <div className="w-full flex-col bg-white p-3vw flex justify-center items-center">
            ...
            <div className="mt-2vw">
              <Link to="/" className="bg-purple-950 p-vw text-white font-medium text-[0.8vw] text-center">View all sales news</Link>
            </div>
        </div>
      </Layout>
    </div>
