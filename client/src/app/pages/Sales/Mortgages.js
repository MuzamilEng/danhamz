  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-white'>
        <p className='text-[1.7vw] text-purple-950 font-semibold w-full max-w-[38vw]'>
          <span className='text-[1.3vw] text-purple-950 font-normal w-full max-w-[37vw]'>
      ...
      <article className="w-full">
       ...
       <div className="p-3vw bg-pink-400 col-center">
        <h1 className='text-purple-950 text-[1.6vw] font-medium text-center w-full max-w-[40vw]'>
        Download and take away our useful guide: Why Use a Mortgage Broker?.</h1>
        <Link to='/contact' className='mt-2vw text-center text-vw p-0.5vw bg-purple-950 text-white'>Make a Mortgage Enquiry</Link>
      </div>
      {/* banner white */}
      <div className="col-center p-3vw bg-white w-full">
        ...
        <div className="w-full flex-col bg-white p-3vw flex justify-center items-center">
            ...
            <div className="mt-2vw">
              <Link to="/" className="bg-purple-950 p-vw text-white font-medium text-[0.8vw] text-center">View all news</Link>
            </div>
        </div>
      </Layout>
    </div>
