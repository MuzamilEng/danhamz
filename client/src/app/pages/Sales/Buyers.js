  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-white'>
        <p className='text-[1.7vw] text-purple-950 font-semibold w-full max-w-[38vw]'>Looking to buy a new investment property? <br />
          <span className='text-[1.3vw] text-purple-950 font-light w-full max-w-[37vw]'>
      ...
      <section className='relative'>
          ...
          <article className='flex flex-col justify-center items-center w-full p-2vw bg-gray-200'>
            <div className="flex mt-[0.5vw] -ml-3vw justify-between items-start">
              ...
              <section className='flex flex-col pt-2vw justify-end items-center mt-vw w-[35vw] ml-vw'>
                <h1 style={{lineHeight: '3vw'}} className="text-3vw text-purple-950 font-medium italic w-full text-right max-w-[20vw]">Start your investment journey here.</h1>
                <p className="text-[1.5vw] text-purple-950 w-full mt-vw text-right max-w-[20vw]">Search our available buy to let properties for sale.</p>
          ...
          <article className="col-center bg-gray-200 w-full p-3vw">
            <h1 className='text-purple-950 text-[2.1vw] font-medium'>Why buy your investment property with us?</h1>
             {/* doings */}
          ...
          <div className="w-full flex-col bg-white p-2vw flex justify-center items-center">
            <h1 className='text-blue-950 text-[1.9vw] text-center font-medium capitalize text-medium'>Investment properties for Sale</h1>
            ...
            <Link to="/" className="bg-purple-950 mt-2vw block p-vw m-vw text-white font-medium text-[0.8vw] text-center">Search all properties</Link>
          </div>
          {/* next investment */}
      ...
      <article className="bg-gray-200">
        ...
        <div className="w-full flex-col bg-white p-3vw flex justify-center items-center">
            <h1 className='text-blue-950 font-medium  text-[1.8vw]'>You may also be interested in</h1>
            ...
            <div className="mt-2vw">
              <Link to="/" className="bg-purple-950 p-vw text-white font-medium text-[0.8vw] text-center">View all investments news</Link>
            </div>
        </div>
      </Layout>
    </div>
