  ...
  return (
    <div>
      ...
      <article className='row-center p-3vw bg-gray-200'>
          <span className='text-[2vw] text-purple-950 font-semibold w-full max-w-[37vw]'>
      ...
      <section className="w-full bg-gray-200 p-3vw col-center">
        <h1 className="text-2vw text-purple-950 font-semibold text-center">
      ...
      <div className="p-3vw w-full col-center bg-gray-200">
        <h1 className="text-center text-purple-950 text-2vw">Choosing the right kind of investment</h1>
          ...
          <div className="w-full flex justify-center items-center">
            {detailCards?.map((item, index) => (
              <main className="w-full m-vw max-w-[38vw] p-2vw bg-white" key={index}>
                ...
                <h1 className="text-[1.7vw] text-purple-950 font-medium">{item?.title}</h1>
                <img src={item?.img} alt="img" className='w-full mt-0.5vw max-w-[35vw] h-20vw' />
                <h1 className="text-[1.3vw] text-purple-950 ml-0.5vw mt-0.5vw font-medium">{item?.propertyTitle}</h1>
                ...
                <h1 className="text-[1.3vw] ml-0.5vw mt-0.5vw text-purple-950 font-medium">{item?.location}</h1>
                <div className="mt-vw">
      ...
      <div className="p-3vw bg-white col-center w-full">
        ...
        <section className="mt-vw col-center p-vw">
          ...
          <div className="mt-vw">
          <Link to="" className='text-purple-950 text-vw cursor-pointer mt-2vw'>View profile</Link>
          </div>
        </section>
        <Link to='/contact' className='mt-2vw text-vw text-center p-vw bg-purple-950 text-white'>Meet full team</Link>
      </div>
        {/* services */}
        <div className="flex justify-center p-vw w-full items-center flex-col">
            <div className="w-full max-w-[55vw] p-2vw">
              <h1 className='text-blue-950 text-[2vw] w-full max-w-[47vw] text-center'>About our Property Sourcing Service</h1>
      ...
      <div className="p-3vw bg-purple-950 col-center">
       ...
       <div className="w-full flex-col bg-white p-3vw flex justify-center items-center">
            <h1 className='text-blue-950 font-semibold italic text-[1.8vw]'>You may also be interested in</h1>
